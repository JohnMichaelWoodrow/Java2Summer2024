...
/**
 * BlackJack Project
 * Represents a client that connects to the Blackjack server and plays the game.
 * Handles user input and server communication.
 * @author john-michael woodrow
 */

/**
 * Constructs a new client for the Blackjack game
 */
public class Client {
    ...
    private static boolean readServerResponses(BufferedReader in) throws IOException {
       ...
       do {
        ...
        }  while ((response = in.readLine()) != null && !response.equals("END OF MESSAGE"));
        return roundEnded;
    }
}
